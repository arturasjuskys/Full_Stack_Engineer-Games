# IT Career Switch - React - Tic Tac Toe
### CodeCademy | Full-Stack Engineer | React, Part I
This is a small React powered game runed in a local server and played in the browser window.
## Description
* Lets you play tic-tac-toe
* Indicates when a player has won the game
* Stores game's history as a game progresses
...
### Challenges
Here are some ideas for improvements to make, listed in order of increasing difficulty:
...
* Setup, creating Tic Tac Toe grid - https://reactjs.org/tutorial/tutorial.html#setup-option-2-local-development-environment
